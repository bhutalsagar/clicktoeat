...
public class ProductServiceImpl {
	...
	public Map<String, Object> addSubCategory(SubCategoryDTO subCategoryDto)
	{
		...
		for (SubCategory s : list) {
			if(s.getCrustType().equals(subCategoryDto.getdishName()) && s.getSize().equals(subCategoryDto.getSize()))
			{
				flag = false;
			}
		}
		...
		subCategory.setCrustType(subCategoryDto.getdishName());
	...
	public SubCategoryDTO getProductPrice(SubCategoryDTO subCategoryDto)
	{
		...
		for (SubCategory sub : subCategoryList) {
			if(sub.getSize().equals(subCategoryDto.getSize()) && sub.getCrustType().equals(subCategoryDto.getdishName()))
			{
				return converter.toSubCategoryDto(sub);
			}
		}
