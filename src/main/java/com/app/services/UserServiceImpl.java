...
public class UserServiceImpl {
	...
	public UserDTO saveUserDetails(UserDTO userDto) {
		...
		User user = converter.toUserEntity(userDto);//converting from DTO to entity
	...
	{
		User resetUser = userDao.findByEmail(cred.getEmail());//fetching user info based on email id
		if(resetUser != null)
		{
			String rawPassword = cred.getPassword();
			String encPassword = passwordEncoder.encode(rawPassword);
